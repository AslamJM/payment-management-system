...
CREATE TABLE `Collector` (
    ...
    UNIQUE INDEX `Collector_name_key`(`name`),
    UNIQUE INDEX `Collector_phone_key`(`phone`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Payment` (
    ...
    `saleable_return` DOUBLE NOT NULL,
    ...
    UNIQUE INDEX `Payment_invoice_number_key`(`invoice_number`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Payment` ADD CONSTRAINT `Payment_shop_id_fkey` FOREIGN KEY (`shop_id`) REFERENCES `Shop`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Payment` ADD CONSTRAINT `Payment_collector_id_fkey` FOREIGN KEY (`collector_id`) REFERENCES `Collector`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
